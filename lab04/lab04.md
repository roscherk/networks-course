...
#### Демонстрация работы
Логи доступны в файле `log/1a.log`.

Скриншот работы GET-запроса:

<img src="./images/1a_get.png">

POST-запрос:
<img src="./images/1a_post.png">
...
#### Демонстрация работы
Логи доступны в файле `log/1c.log`.

Заблокированный GET-запрос:
<img src="./images/1c_get.png">
