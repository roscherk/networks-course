...
class RIPNetwork:
    ...
    def simulate_rip(self, max_iterations: int = 20, show_intermediate: bool = True):
        ...
        for iteration in range(max_iterations):
            ...
            if show_intermediate:
                for router_ip in sorted(self.routers.keys()):
                    self.routers[router_ip].print_routing_table(f"Simulation step {iteration + 1} of router {router_ip}")
...
def main():
    ...
    network.simulate_rip(show_intermediate=True)
